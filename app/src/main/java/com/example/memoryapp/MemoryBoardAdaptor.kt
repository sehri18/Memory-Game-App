...
class MemoryBoardAdaptor(private val context: Context,
    ...
    // The Adaptor class is an abstract hence we must override below member methods.
    ...
    // The ViewHolder will be an inner class of our Adaptor class in order to provide individual items.
